    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://i.ibb.co/kMzf4Rz/picofme-2.jpg"
              alt="Vishal portrait"
              width="192"
              height="192"
              quality="95"
      ...
      >
        ...
        <a
          ...
          href="https://drive.usercontent.google.com/download?id=1nQkiAzXmXcQ27bo32824coCUN_gLsVaE&export=download"
          target="_blank"
          download
        >
          Download Resume{" "}
        ...
        <motion.div
                className="flex mt-6 sm:flex-row items-center justify-center gap-4 px-4 text-lg font-medium"
                initial={{ opacity: 0, y: 100 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{
                  delay: 0.1,
        ...
        <a
          ...
          href="https://www.linkedin.com/in/vishalshah001/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/Visha193/"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.geeksforgeeks.org/user/vishal0015//"
          target="_blank"
        >
          <SiGeeksforgeeks/>
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://leetcode.com/vishal0015/"
          target="_blank"
        >
          <SiLeetcode />
        </a>
